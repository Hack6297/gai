const STORAGE_KEY = "gai-build-50-chats";
...
function renderMessages() {
  ...
  for (const msg of chat.messages) {
    ...
    const name = msg.role === "user" ? "You" : "gai";
    article.innerHTML = `
...
async function askGai(message) {
  ...
  try {
    ...
    chat.messages.push({
      role: "assistant",
      text: "I could not reach the gai server. Start it with: python app.py",
    });
    saveChats();
    renderAll();
  }
